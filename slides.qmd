...
![](assets/anadyr_adcp_glofas2.png){fig-align="center"}

# If I haven't convinced you yet... {transiton="zoom"}

# Koryakskaya River example (Kamchatka) <br><br> 🌋 {background-color="#212121" transiton="zoom"}

##
![](assets/koryaki_hydrograph.png){fig-align="center"}

<span style='font-size:50%; color:grey;'>Avacha River basin</span>
...
# Take home message <br><br> 🏠 {background-color="#212121" transiton="zoom"}
...
* Detrended Quantile Mapping can increase `GloFAS-ERA5` accuracy by ≈20%

* DQM is sensitive to the number of quantiles and requires tuning.
:::

## Take home message v1.2

:::::::: {.columns}
:::: {.column width="40%" align='left'}

![](assets/qr-code.png){width=60% fig-align="center"}

<div style="font-size:70%; text-align:center;">Follow me:</div>

::::

:::: {.column width="60%" align='right'}

![](assets/logo.gif){width=40% fig-align="center"}

<div style="font-size:70%; text-align:center;">Телеграм канал — <b>Типизированный R</b></div>
