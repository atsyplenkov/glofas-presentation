  ...
  dplyr::mutate(
    tooltip = glue::glue(
      ...
      <div style='background:white;box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px;'>
        <div style='padding:8px; font-weight: bold; margin-bottom: 8px; font-size: 16px;background:black;color:white;'>{date}</div>
